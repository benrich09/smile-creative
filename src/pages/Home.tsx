...
const services = [
  ...
  },
  {
    ...
    desc: 'Digital invitation cards for weddings, birthdays and events, with custom design and easy sharing.',
    path: '/services#ecard',
            ...
            >
              <div className="relative rounded-2xl border border-white/10 bg-white/[0.04] backdrop-blur-sm p-7 md:p-9 shadow-soft-lg">
                ...
                <div className="mt-6 pt-5 border-t border-white/10 grid grid-cols-3 gap-4 text-center">
                  <div>
                    <p className="text-gold font-display text-xl md:text-2xl font-semibold">4</p>
